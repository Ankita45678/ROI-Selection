...
(h, w) = image.shape[:2]
blo = cv2.dnn.blobFromImage(cv2.resize(image, (300, 300)), 0.007843, (300, 300), 127.5)

print("[INFO] computing object detections...")
network.setInput(blo)
...
for i in np.arange(0, detect.shape[2]):
	...
	if confid > args["confidence"]:
		...
		label = "{}: {:.2f}%".format(CLASSES[idx], confid * 100)
